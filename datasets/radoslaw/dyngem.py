...
primary_model_build_epochs_number = 20  # 0.78 in 100 50  , 0.8 in 20 50
dynamic_model_build_epochs_number = 50
...
def build_model():
    ...
    encoding_layers = []
    decoding_layers = []
    dynamic_series = loadRealGraphSeries('snapshots/s',1,10)
    count = 0
    node_count = []
    #Initial Values
    beta=2
